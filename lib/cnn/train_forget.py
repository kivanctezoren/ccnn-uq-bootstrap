...
valid_fashion_mnist_loader = DataLoader(dataset=valid_dataset, batch_size=16, shuffle=False)
...
valid_mnist_loader = DataLoader(dataset=valid_dataset, batch_size=16, shuffle=False)
...
forget_model_mnist = CNN(10).to(device)

learning_rate = 5e-4
batch_size = 32
num_samples = 200 # number of samples drawn per each sampling
num_iter = 100 # number of sampling iterations
conf_level = 95 # percentage of confidence level aiming to be obtained
epochs = 5 # how many epochs each sampling run should take
